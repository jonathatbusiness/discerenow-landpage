        ...
        <section className="mx-auto grid max-w-6xl gap-6 px-5 py-8 sm:px-6 lg:grid-cols-[minmax(0,1fr)_320px] lg:px-8">
          ...
          <aside className="space-y-5">
            ...
            <div className="rounded-[22px] border border-dn-border bg-gradient-to-br from-white to-dn-surface-soft p-5 shadow-dn-soft">
              ...
              <Link
                href="/#download"
                className="mt-5 flex w-full items-center justify-center gap-2 rounded-full bg-dn-pink px-6 py-3 text-base font-black text-white shadow-[0_18px_45px_rgba(236,72,153,0.28)] transition hover:scale-[1.02] hover:bg-pink-500 hover:shadow-[0_22px_55px_rgba(236,72,153,0.34)]"
              >
